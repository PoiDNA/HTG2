...
export default function SluchajButton() {
  return (
    <Link
      href="/konto/sluchaj"
      className="flex items-center justify-center gap-3 bg-htg-card border-2 border-htg-card-border rounded-xl p-6 hover:border-htg-sage/50 transition-colors group min-w-[180px] h-full"
    >

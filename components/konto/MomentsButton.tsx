  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span className="text-[58px] font-serif font-bold leading-none text-htg-fg">M</span>
      </div>
      <span className="text-sm font-serif font-semibold text-htg-fg-muted opacity-0 group-hover:opacity-100 transition-opacity duration-500">Momenty</span>
    </Link>
  );
}

          ...
          return (
            <div key={month.monthLabel} className="bg-htg-card border border-htg-card-border rounded-xl overflow-hidden">
              ...
              >
                {month.coverImageUrl && (
                  <div
                    className={`hidden sm:block absolute inset-y-0 right-0 sm:w-1/3 md:w-1/2 ${expandedKey === month.monthLabel ? 'scale-105 dark:opacity-40' : 'dark:opacity-20'} group-hover:scale-105 dark:group-hover:opacity-40 transition-[opacity,transform] duration-300 pointer-events-none`}
                    aria-hidden="true"
                    style={{

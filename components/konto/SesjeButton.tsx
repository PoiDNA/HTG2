...
export default function SesjeButton() {
  return (
    <Link
      ...
      className="flex flex-col items-center justify-center gap-3 bg-htg-card border-2 border-htg-card-border rounded-xl p-4 hover:border-htg-sage/50 transition-colors group h-full min-h-[160px]"
    >
      ...
      <span className="text-sm font-serif font-semibold text-htg-fg">Sesje</span>
    </Link>
  );
}

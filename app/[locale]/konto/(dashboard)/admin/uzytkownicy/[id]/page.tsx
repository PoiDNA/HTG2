        ...
        <div className="bg-htg-card border border-htg-card-border rounded-2xl p-6">
          ...
          <div className="space-y-2">
            {upcomingBookings.map(b => {
              ...
              return (
                <Link key={b.id} href={{pathname: '/konto/admin/planer/[id]', params: {id: b.id}}} className="flex items-center justify-between py-2.5 px-3 bg-htg-surface rounded-lg gap-2 flex-wrap hover:bg-htg-surface/70 transition-colors">
        ...
        <div className="bg-htg-card border border-htg-card-border rounded-2xl p-6">
          ...
          <div className="space-y-1 max-h-64 overflow-y-auto">
            {pastBookings.map(b => {
              const ps = b.payment_status ? PAYMENT_STATUS_BADGE[b.payment_status] : null;
              return (
                <Link key={b.id} href={{pathname: '/konto/admin/planer/[id]', params: {id: b.id}}} className="flex items-center justify-between py-2 px-3 bg-htg-surface rounded-lg gap-2 flex-wrap hover:bg-htg-surface/70 transition-colors">
                  <div>

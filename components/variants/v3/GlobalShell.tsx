      ...
      {!isNagrania && (
        <ScrollHeader bgClassName="bg-htg-card backdrop-blur-md border-b border-htg-card-border/50">
          <div className="mx-auto max-w-5xl px-4 py-2 flex items-center justify-between gap-4">
            ...
            <nav className="flex-1 flex justify-center transition-opacity duration-500 group-data-[scroll-state=visible]:opacity-0 group-data-[scroll-state=visible]:pointer-events-none group-data-[scroll-state=hidden]:opacity-0 group-data-[scroll-state=hidden]:pointer-events-none">
              <NavLinks />
            </nav>
            <SiteNav />
          </div>

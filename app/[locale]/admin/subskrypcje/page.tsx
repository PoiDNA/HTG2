  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <CreditCard className="w-6 h-6 text-htg-indigo" />
        <h2 className="text-2xl font-serif font-bold text-htg-fg">{t('subscriptions_admin')}</h2>
      </div>
      <div className="bg-htg-card border border-htg-card-border rounded-xl p-8 text-center">
        ...
        <p className="text-htg-fg-muted">{t('subscriptions_desc')}</p>
      </div>
    </div>
  );
}
